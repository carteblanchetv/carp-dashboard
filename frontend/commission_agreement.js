...
async function generatePDF(sub, currentUser, commNum, commDate) {
    ...
    const clauses = [
        ...
        "The producer shall have a period of two days to film the insert. Should the producer require additional days to film the insert, the producer must immediately request, telephonically and in writing, the company to authorize the additional days. All expenses incurred during the additional filming days shall be for the company's account and will be settled on receipt of proof of expenses.",
